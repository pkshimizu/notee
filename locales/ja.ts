export default {
  ...
  'Could not upload due to insufficient capacity': '容量不足のためアップロードできませんでした',
  ...
  'Moved file to trash': 'ゴミ箱に移動しました',
